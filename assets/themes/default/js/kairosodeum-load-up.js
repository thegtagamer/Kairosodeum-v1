// SLIDER OPTIONS
$(function() {
	$('#kairosodeum-single-thumb').utilCarousel({
...
$(function() {	
	$('#kairosodeum-module-featured').utilCarousel({
	...
	$('#kairosodeum-module-gallery').utilCarousel({
		responsiveMode : 'breakPoints',
		responsive : true,
		mouseWheel : false,
		drag : true,
	...
	$('#kairosodeum-module-news').utilCarousel({
		responsiveMode : 'breakPoints',
		responsive : true,
		mouseWheel : false,
		drag : true,
	...
	$('#kairosodeum-module-bignews').utilCarousel({
		responsiveMode : 'breakPoints',
		responsive : true,
		mouseWheel : false,
		drag : true,
