...
if (isset($_POST['email'])) {
    ...
    if ((!$email) || (!$pass)) {
        ...
        if ($login_check > 0) {
            ...
            $errorMsg = '<div class="alert alert-danger fade in">
							<a href="#" class="close" data-dismiss="alert">&times;</a>
							<strong>Error!</strong> Login not succesfull, Please try again.
						</div>';
            echo $errorMsg;
        }
    }
...
if (isset($_POST['email_reg'])) {
    ...
    if ((!$username) || (!$user_type) || (!$email) || (!$pass) || (!$city)) {
        ...
        $errorMsg = '<div class="alert alert-danger fade in">
						<a href="#" class="close" data-dismiss="alert">&times;</a>
						<strong>Error!</strong> You must fill all the informations.
					</div>';
        echo $errorMsg;
    } else if ($email_check > 0) {
		$errorMsg = '<div class="alert alert-danger fade in">
						<a href="#" class="close" data-dismiss="alert">&times;</a>
						<strong>Error!</strong> Your Email address is already in use inside of our system. Please use another.
					</div>';
        echo $errorMsg;
        // echo 'error';
			...
			<ul>
				<li class="active">
					<a href="#sidebarmenu" data-toggle="tab">
						<span class="kairosodeum-btn-tab-sidebar">Login</span>
					</a>
				</li>	
				<li>
					<a href="#sidebarwidget" data-toggle="tab">
						<span class="kairosodeum-btn-tab-sidebar">Sign Up</span>
					</a>
				</li>
			</ul>
			<div class="clearfix"></div>
			<div class="hidden-md hidden-lg kairosodeum-sidebar-closed">
				<span class="btn btn-block btn-lg btn-success"><i class="fa fa-times"></i> Close</span>
			</div>
			<div class="clearfix"></div>
			<div class="clearfix"></div>
					...
					<div class="col-md-6">
						<div class="kairosodeum-single-gallery">
							<a class="kairosodeum-video-popup" href="#kairosodeum-video144">
								<img width="700" height="450" src="assets/uploads/2017/10/photo-1429305254053-2a1bfe816f36-700x450.jpg" class="attachment-kairosodeum-thumb-formal size-kairosodeum-thumb-formal wp-post-image" alt="" />									
								<div class="kairosodeum-video-play">
						...
						<div class="kairosodeum-mod-detail ">
							...
							<h2>"It&#039;s Awesome Movie"</h2>
						</div>
						<div id="kairosodeum-video144" class="mfp-hide">
							<div class="col-md-2"></div>
							<div class="col-md-8">
								<div class="embed-container">
									<iframe width="200" height="113" src="https://www.youtube.com/embed/cXuC_v0KWaU?feature=oembed" frameborder="0" allowfullscreen></iframe>								
								</div>
							</div>
							<div class="col-md-2"></div>
						</div>
					...
					<div class="col-md-6">
						<div class="kairosodeum-single-gallery">
							<a class="kairosodeum-video-popup" href="#kairosodeum-video188">
								<img width="700" height="450" src="assets/uploads/2017/10/photo-1436128003323-97dab5d267a9-700x450.jpg" class="attachment-kairosodeum-thumb-formal size-kairosodeum-thumb-formal wp-post-image" alt="" />									
								<div class="kairosodeum-video-play">
									<i class="fa fa-play"></i>
								</div>
							</a>
						...
						<div class="kairosodeum-mod-detail ">
							...
							<h2>"Little Prince in Life"</h2>
						</div>
						<div id="kairosodeum-video188" class="mfp-hide">
							<div class="col-md-2"></div>
							<div class="col-md-8">
								<div class="embed-container">
									<iframe width="200" height="113" src="https://www.youtube.com/embed/dJ8hccoZ6hQ?feature=oembed" frameborder="0" allowfullscreen></iframe>								
								</div>
							</div>
							<div class="col-md-2"></div>
						</div>
					...
					<div id="kairosodeum-module-news" class="util-carousel team-showcase kairosodeum-mod-featcon">
						...
						<!--<div class="item">
							<div class="meida-holder kairosodeum-mod-thumb">
								<div class="kairosodeum-single-gallery">
									<a href="index.php">
										<img width="700" height="450" src="assets/uploads/2017/10/photo-1436759644647-e274ee931eaa-700x450.jpg" class="attachment-kairosodeum-thumb-formal size-kairosodeum-thumb-formal wp-post-image" alt="" />											
										<div class="kairosodeum-hover-play"><i class="fa fa-search-plus"></i></div>
									</a>
								</div>
							</div>
							<div class="kairosodeum-mod-detail kairosodeum-mod-news-detail ">
						...
						<!--<div class="item">
							<div class="meida-holder kairosodeum-mod-thumb">
								<div class="kairosodeum-single-gallery">
									<a href="index.php">
										<img width="700" height="450" src="assets/uploads/2017/10/photo-1435458983855-85e70c381591-700x450.jpg" class="attachment-kairosodeum-thumb-formal size-kairosodeum-thumb-formal wp-post-image" alt="" />											
										<div class="kairosodeum-hover-play"><i class="fa fa-search-plus"></i></div>
									</a>
								</div>
							</div>
						...
						<!--<div class="item">
							<div class="meida-holder kairosodeum-mod-thumb">
								<div class="kairosodeum-single-gallery">
									<a href="index.php">
										<img width="700" height="450" src="assets/uploads/2017/10/22-700x450.jpg" class="attachment-kairosodeum-thumb-formal size-kairosodeum-thumb-formal wp-post-image" alt="" />											
										<div class="kairosodeum-hover-play"><i class="fa fa-search-plus"></i></div>
									</a>
								</div>
							</div>
					...
					<div id="kairosodeum-module-gallery" class="util-carousel team-showcase kairosodeum-mod-featcon">
						...
						<div class="item">
							<div class="meida-holder kairosodeum-mod-thumb">
								<div class="kairosodeum-single-gallery">
									<a href="#">
										<img width="450" height="450" src="assets/uploads/2017/10hoto-1436190807865-2e156d40f1a2-450x450.jpg" class="attachment-kairosodeum-thumb-medium size-kairosodeum-thumb-medium wp-post-ima" srcset="assets/uploads/2017/10/photo-1436190807865-2e156d40f1a2-450x450.jpg 450w, assetsuploads/2017/10/photo-1436190807865-2e156d40f1a2-150x150.jpg 150w"> 					
										<div class="kairosodeum-hover-play"><i class="fa fa-search-plus"></i></div>
									</a>
								</div>
							</div>
